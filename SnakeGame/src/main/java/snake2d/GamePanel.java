...
public class GamePanel extends JPanel implements ActionListener, KeyListener{
   // private ImageIcon snaketitle= new ImageIcon(getClass().getResource("snaketitle.jpg"));
    ...
    private ImageIcon snaketitle=new ImageIcon(getClass().getResource("gameon.png"));
    String leftm="rightm.png";
    ImageIcon leftmouth=new ImageIcon(getClass().getResource(leftm));
    private ImageIcon rightmouth=new ImageIcon(getClass().getResource("leftm.png"));
    private ImageIcon upmouth=new ImageIcon(getClass().getResource("SanpeU.png"));
    private ImageIcon downmouth=new ImageIcon(getClass().getResource("SnakeDow.png"));
    private ImageIcon snakeimage=new ImageIcon(getClass().getResource("snakeb.png"));
